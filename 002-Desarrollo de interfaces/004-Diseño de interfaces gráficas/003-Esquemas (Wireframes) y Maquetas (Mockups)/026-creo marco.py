...
def nuevo(tabla):
    ...
    tk.Label(marcoinsertar, text="Campo 1:", bg="white").pack(padx=10, pady=5)
    tk.Entry(marcoinsertar).pack(padx=10, pady=5)
    tk.Label(marcoinsertar, text="Campo 2:", bg="white").pack(padx=10, pady=5)
    tk.Entry(marcoinsertar).pack(padx=10, pady=5)
    tk.Button(marcoinsertar, text="Guardar").pack(padx=10, pady=10)
