...
def busqueda():
    ...
    cursor.execute("SELECT Identificador,disco,carpeta,archivo,datetime(fecha, 'unixepoch') AS fecha_human_readable,tamaño FROM archivos WHERE archivo LIKE ?", ('%' + search_term + '%',))
